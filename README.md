...
| **4. Model Training** | Huấn luyện 5 mô hình, tune threshold trên valid và chọn best | Split datasets         | `deployment_models/best_model_4w.pkl` + `evaluation_metrics.csv`                       |              — |
| **5. Evaluation**     | Đánh giá cuối trên test sau khi khóa model       | Best model + test data | `final_test_metrics.csv` / `best_model_metadata.json`                                  |              — |
...
Ghi chú về valid/test ở stage 4:
